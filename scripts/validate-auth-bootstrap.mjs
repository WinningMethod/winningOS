...
assert(signInPage.includes("SIGN_IN_ERROR_CODES") && signInPage.includes("typeof SIGN_IN_ERROR_CODES[number]"), "sign-in error code guard derives from one const source")
...
assert(signInPage.includes("const errorMessage = sent ? null"), "sign-in page does not show sent and error banners at the same time")
