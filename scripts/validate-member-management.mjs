...
assert(memberData.includes("canInviteMembers"), "member list helper exposes owner-only invite permission")
...
assert(membersPage.includes('title={canInviteMembers ? undefined : "Owner only"}'), "members page labels disabled invite button as owner-only")
