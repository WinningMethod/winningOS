...
assert(membersPage.includes("removeMember"), "members page exposes remove/revoke action")
assert(membersPage.includes("Remove invite"), "members page can remove stale invites")
